...
public class MaterialMenuDrawable extends Drawable implements Animatable {
    ...
    public MaterialMenuDrawable(Context context, int color,
                                Stroke stroke, int transformDuration) {
        this(context, color, stroke, DEFAULT_SCALE, transformDuration);
    }

    public MaterialMenuDrawable(Context context, int color,
                                Stroke stroke, int scale, int transformDuration) {
    ...
    private MaterialMenuDrawable(int color, Stroke stroke, long transformDuration,
                                 int width, int height, float iconWidth, float circleRadius,
    ...
    public IconState setTransformationOffset(AnimationState animationState, float offset) {
        if (offset < TRANSFORMATION_START || offset > TRANSFORMATION_END) {
            throw new IllegalArgumentException(
                    String.format("Value must be between %s and %s",
    ...
    private boolean resolveTransformation() {
        ...
        throw new IllegalStateException(
                String.format("Animating from %s to %s is not supported",
