...
//        }
    ...
    class CustomShadow {
        ...
        public void drawShadow(Canvas canvas, DepthLayout dl, Drawable shadow) {
            ...
            float[] src = new float[]{0, 0, dl.getWidth(), 0, dl.getWidth(),
                    dl.getHeight(), 0, dl.getHeight()};
            float[] dst = new float[]{topLeftBack.x, topLeftBack.y, topRightBack.x,
                    topRightBack.y, bottomRightBack.x, bottomRightBack.y,
                    bottomLeftBack.x, bottomLeftBack.y};
