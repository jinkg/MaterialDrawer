...
public class CircularSplashView extends View {
    ...
    public class CircleBitmapExpand implements CircledDrawable {
        ...
        public void startAnim() {
            Rect startRect = new Rect(targetSize.centerX(), targetSize.centerY(),
    ...
    public class CircleColorExpand implements CircledDrawable {
        ...
        public CircleColorExpand(RectF targetSize, long startDelay,
                                 long animDuration, int paintColor) {
            this.targetSize = targetSize;
            this.startDelay = startDelay;
            this.animDuration = animDuration;
        ...
        public void startAnim() {
            RectF startRect = new RectF(targetSize.centerX(), targetSize.centerY(),
                    targetSize.centerX(), targetSize.centerY());
